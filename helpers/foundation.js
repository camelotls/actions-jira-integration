...
const jira = require('./jira-helpers');
...
const kickOffAction = async(inputJson) => {
    ...
    log.info('Attempting to search for existing resolved issues...');
    ...
    log.info(`${resolvedIssues.length} resolved issues have been retrieved!`);
    log.info('Attempting to search for existing open issues...');
    ...
    log.info(`${openIssues.length} open issues have been retrieved!`);
