...
const provideEnvironment = (envVars) => {
    process.env = {
        ...
        REPORT_INPUT_KEYS: readFileSync('./test/testdata/envVars/reportInputKeys', 'utf8'),
        ...
        JQL_SEARCH_PAYLOAD_RESOLVED_ISSUES: 'project=SET1',
        JQL_SEARCH_PAYLOAD_OPEN_ISSUES: 'project=SET1',
    };
};
...
const getIssuesFromJira = async() => {
    ...
    const response = await jira.searchExistingJiraIssues(jiraAuthHeaderValue, process.env.JQL_SEARCH_PAYLOAD_OPEN_ISSUES);
